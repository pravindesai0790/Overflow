...
{
    // this method will create collection schema for questions in typesense if not available (initially).
    // which is called at app initialization time (from Program.cs class)
