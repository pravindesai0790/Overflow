...
{
    public static async Task MigrationDbContextAsync<TContext>(this IHost host) where TContext : DbContext
    {
        ...
        logger.LogInformation("Migrated completed for {Name}", typeof(TContext).Name);
    }
}